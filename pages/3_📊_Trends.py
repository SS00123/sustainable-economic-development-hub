...
from analytics_hub_platform.ui.ui_components import section_header, spacer, card_container, apply_chart_theme
...
with main_col:
    ...
    with col_f1:
        region = st.selectbox("Region", 
            ...
            index=0, key="trend_filter_region")
    with col_f2:
    ...
    try:
        ...
        section_header("Indicator Trends", "Select an indicator to view historical performance", "📈")
        ...
        if len(regional_df) > 0:
            ...
            with reg_col1:
                ...
                colors = [COLORS.purple if v >= national_avg else COLORS.pink for v in regional_agg["sustainability_index"]]
                ...
                fig.add_vline(
                    ...
                    annotation_font=dict(color=COLORS.text_muted)
                )
                
                apply_chart_theme(fig, height=450)
                fig.update_layout(
                    xaxis=dict(showgrid=True, title="Sustainability Index"),
        ...
        section_header("Environmental Trends", "Multi-indicator sustainability performance over time", "🌿")
