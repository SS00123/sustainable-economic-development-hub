...
from analytics_hub_platform.ui.ui_components import section_header, spacer, info_banner
from analytics_hub_platform.ui.dark_components import render_sidebar, render_advanced_analytics_sidebar
            ...
            if selected_section == "forecast":
                ...
                try:
                    ...
                    if not all_anomalies:
                        info_banner(f"All Systems Normal - No significant anomalies detected. All {len(available_kpis)} monitored KPIs are within expected ranges.", "success")
                        ...
                        for anomaly in sorted(all_anomalies, key=lambda x: (x.severity.value, -x.year, -x.quarter))[:10]:
                            severity_color = COLORS.status_red if anomaly.severity == AnomalySeverity.CRITICAL else COLORS.status_amber
                ...
                section_header("AI Strategic Recommendations", "LLM-powered insights aligned with Vision 2030", "🤖")
                ...
                try:
                    ...
                    if len(regional_df) > 0:
                        ...
                        if available_kpis:
                            ...
                            region_mapping = {
                                "Riyadh": "riyadh", "Makkah": "makkah", "Eastern Province": "eastern",
                                "Madinah": "madinah", "Qassim": "qassim", "Asir": "asir",
                                "Tabuk": "tabuk", "Hail": "hail", "Northern Borders": "northern_borders",
                                "Jazan": "jazan", "Najran": "najran", "Al Bahah": "bahah", "Al Jawf": "jawf",
                            }
