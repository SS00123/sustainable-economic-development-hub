...
def validate_quarter(quarter: Union[int, str]) -> int:
    """
...
def validate_percentage(value: Union[int, float, str], field_name: str = "Value") -> float:
    """
...
def validate_filter_params(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if 'regions' in params and params['regions']:
        validated['regions'] = [
            sanitize_string(r, max_length=100) for r in params['regions']
        ]
...
def validate_kpi_data(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    numeric_fields = [
        ...
        'employment_rate', 'data_quality_score',
    ]
