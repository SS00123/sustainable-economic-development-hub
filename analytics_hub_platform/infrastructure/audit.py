...
from analytics_hub_platform.infrastructure.db_init import audit_log, get_engine
...
def log_audit_event(
    ...
    try:
        ...
        logger.info(f"Audit: {action} by {user_id or 'anonymous'} on {resource_type or 'N/A'}")
