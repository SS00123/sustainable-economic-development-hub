...
def co2_per_gdp(co2_total: Optional[float], gdp_total: Optional[float]) -> Optional[float]:
    """
...
def co2_per_capita(co2_total: Optional[float], population: Optional[float]) -> Optional[float]:
    """
...
def get_kpi_status(
    value: Optional[float],
    thresholds: Optional[KPIThresholds],
...
def get_sustainability_weights(catalog: Optional[Dict[str, Any]] = None) -> Dict[str, float]:
    """
...
def get_kpi_ranges(catalog: Optional[Dict[str, Any]] = None) -> Dict[str, Tuple[float, float, bool]]:
    """
...
def calculate_sustainability_index(
    ...
    ranges: Optional[Dict[str, Tuple[float, float, bool]]] = None
) -> Optional[float]:
    """
