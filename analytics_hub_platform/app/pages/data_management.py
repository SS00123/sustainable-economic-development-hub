"""Data management renderers.

Moved from the legacy Streamlit page to keep `pages/` thin and to allow
embedding data-management workflows inside other pages (e.g. Data).
"""
...
def render_upload_section() -> None:
    ...
    if not (validate_only or do_import):
        return
...
def render_dq_report_section() -> None:
...
def render_data_management() -> None:
    """Render the data management workflow (upload, DQ report, explorer)."""
