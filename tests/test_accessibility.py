...
class TestAccessibleMetric:
    ...
    def test_metric_with_delta(self):
        ...
        html = accessible_metric(
            "GDP", "2.5T", delta="+5.2%", delta_description="increased 5.2% from last year"
        )
...
class TestAccessibleDataTable:
    ...
    def test_table_has_role(self):
        ...
        html = accessible_data_table(
            headers=["Name", "Value"], rows=[["GDP", "2.5T"]], caption="Economic indicators"
        )
    ...
    def test_table_has_scope(self):
        ...
        html = accessible_data_table(
            headers=["Name", "Value"], rows=[["GDP", "2.5T"]], caption="Test"
        )
