...
class TestLLMServiceMocking:
    ...
    def test_get_llm_service_mock(self):
        ...
        from analytics_hub_platform.domain.llm_service import get_llm_service, MockLLMProvider
    ...
    def test_generate_recommendations_function(self, sample_kpi_data, sample_anomalies, sample_forecasts):
...
class TestLLMPromptBuilding:
    ...
    def test_system_prompt_english(self):
        ...
        assert "strategic" in prompt.lower() or "recommendation" in prompt.lower() or "vision 2030" in prompt.lower()
...
class TestServiceDependencyMocking:
    ...
    def test_settings_mock(self):
        ...
        with patch('analytics_hub_platform.infrastructure.settings.get_settings', return_value=mock_settings):
    ...
    def test_llm_service_with_mocked_settings(self):
        ...
        with patch('analytics_hub_platform.domain.llm_service.get_settings', return_value=mock_settings):
