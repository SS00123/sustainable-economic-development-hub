...
class TestRepository:
    ...
    def test_get_all_indicators_returns_dataframe(self, repository):
        ...
        result = repository.get_all_indicators(tenant_id="mep-sa-001", filters=None)
    ...
    def test_get_all_indicators_with_filters(self, repository):
        ...
        filters = FilterParams(tenant_id="mep-sa-001", year=2024, quarter=4, region="all")

        result = repository.get_all_indicators(tenant_id="mep-sa-001", filters=filters)
    ...
    def test_get_latest_snapshot_returns_dataframe(self, repository):
        ...
        result = repository.get_latest_snapshot(tenant_id="mep-sa-001", filters=None)
    ...
    def test_get_indicator_timeseries_with_invalid_indicator(self, repository):
        ...
        result = repository.get_indicator_timeseries(
            tenant_id="mep-sa-001", indicator_id="nonexistent_indicator", region="all"
        )
...
class TestCacheIntegration:
    ...
    def test_cache_complex_objects(self, cache):
        ...
        df = pd.DataFrame({"year": [2024, 2024], "quarter": [3, 4], "value": [100.5, 105.2]})
