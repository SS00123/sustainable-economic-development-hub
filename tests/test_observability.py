...
class TestAlertThreshold:
    ...
    def test_alert_threshold_operators(self):
        ...
        # Greater than
        gt = AlertThreshold(
            name="Test", metric="m", operator="gt", threshold=10, severity="warning"
        )
        ...
        # Less than
        lt = AlertThreshold(
            name="Test", metric="m", operator="lt", threshold=10, severity="warning"
        )
        ...
        gte = AlertThreshold(
            name="Test", metric="m", operator="gte", threshold=10, severity="warning"
        )
